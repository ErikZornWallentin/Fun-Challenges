...
Follow these steps:
1. Compile and RUN:
	python iterativeAckermannFunction.py

'Ackermann function iterative in Python: Enter two numbers (Below 4 for a quick result)'
...
Python does not handle Ackermann Function very well, we are aware of this from testing and its a general purpose language,
It can only handle ackermann (3, 6), anything higher like (3,7) is an OVERFLOW! This is expected outcome and no errors on my part.
