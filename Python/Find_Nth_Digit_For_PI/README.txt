****************************************************
Erik Zorn-Wallentin	 find_nth_digit_for_pi.py
Tuesday, May. 10 / 2016
****************************************************
...
Type "python find_nth_digit_for_pi.py" to compile and run the program in the terminal as long as you are in the same directory as the files.
