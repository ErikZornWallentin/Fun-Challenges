****************************************************
Erik Zorn-Wallentin	 length_converter.py
Tuesday, May. 10 / 2016
****************************************************
...
Type "python length_converter.py" to compile and run the program in the terminal as long as you are in the same directory as the files.
