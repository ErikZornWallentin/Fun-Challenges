...
public class MetricConverter {
	...
	private void calculate(){
		String kilometreInput = textField1.getText();
		String metreInput = textField2.getText();
		float kilometreConverted = 0f;
		float metreConverted = 0f;
		
		if (kilometreInput.isEmpty()){
			textField1.setText("1");
			textLabel4.setText("Input is empty! Put in a number to calculate!");
			textLabel4.setBounds(15, 290,
                    350, 30);
		}else{
			kilometreInput = textField1.getText();
			...
			if (errorCheck == true){
				...
				textLabel4.setText(kilometreInput + "km = " + metreConverted +"m");
		...
		if (metreInput.isEmpty()){
			...
			if (errorCheck == true){
				...
				/*  Show conversions to the user */
				textLabel5.setText(metreInput + "m = " + kilometreConverted +"km");
    ...
    public MetricConverter() {
        ...
        JFrame frame = new JFrame("MetricConverter");
        frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
 
        frame.setLayout(null);
 		
		textLabel1 = new JLabel("Metric Converter");
		textLabel1.setFont(new Font("Serif", Font.BOLD, 24));
		
		textLabel2 = new JLabel("Kilometre to Metre (km to m):");
		textLabel2.setFont(new Font("Serif", Font.BOLD, 14));
		
		textLabel3 = new JLabel("Metre to Kilometre (m to km):");
    ...
    public static void main(String[] args) {
        ...
        javax.swing.SwingUtilities.invokeLater(new Runnable() {
            public void run() {
                MetricConverter gui = new MetricConverter( );
				gui.reset();
            }
        });
    }
