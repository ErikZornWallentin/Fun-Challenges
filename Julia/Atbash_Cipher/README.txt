****************************************************
Erik Zorn-Wallentin	 atbash_cipher.jl
...
Type "julia atbash_cipher.jl" to compile and run the program in the terminal as long as you are in the same directory as the files.
