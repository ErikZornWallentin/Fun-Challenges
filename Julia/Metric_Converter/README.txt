****************************************************
Erik Zorn-Wallentin	 metric_converter.jl
...
Type "julia metric_converter.jl" to compile and run the program in the terminal as long as you are in the same directory as the files.
