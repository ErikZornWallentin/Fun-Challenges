****************************************************
Erik Zorn-Wallentin	 temperature_converter.jl
...
Type "julia temperature_converter.jl" to compile and run the program in the terminal as long as you are in the same directory as the files.
