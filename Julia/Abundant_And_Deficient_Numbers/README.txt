****************************************************
Erik Zorn-Wallentin	 abundant_and_deficient_numbers.jl
...
Type "julia abundant_and_deficient_numbers.jl" to compile and run the program in the terminal as long as you are in the same directory as the files.
